# AgentHub Implementation Specification

AgentHub is a curated registry for agent-consumable engineering artifacts such as `AGENTS.md`, `SKILL.md`, command definitions, reusable prompts, context packs, templates, model routing policies, review rubrics, and project scaffolding instructions.
...
3. [`docs/spec/02-manifest-and-lockfile.md`](docs/spec/02-manifest-and-lockfile.md) defines `agenthub.yaml`, `.agenthub.lock.yaml`, validation rules, and path rules.
...
10. [`docs/spec/09-implementation-plan.md`](docs/spec/09-implementation-plan.md) defines the target repo structure, vertical slices, acceptance criteria, and test strategy.
